...
namespace WindowsPrometheusSync.Test
{
    ...
    public class PrometheusConfigChangeTrackerTests
    {
        ...
        [TestCase("blank-with-scrape-job.yaml", "blank-with-scrape-job-and-default-node.yaml",
            TestName = "Add_StartWithBlankIncJob")]
        [TestCase("default.yaml", "default-with-scrape-job-and-default-node.yaml", TestName = "Add_StartWithDefault")]
        [TestCase("default-with-scrape-job.yaml", "default-with-scrape-job-and-default-node.yaml",
            TestName = "Add_StartWithDefaultIncJob")]
        ...
        [TestCase("blank-with-scrape-job.yaml", "blank-with-scrape-job.yaml", false,
            TestName = "Initial_StartWithBlankIncJob")]
        [TestCase("blank-with-scrape-job-and-default-node.yaml", "blank-with-scrape-job-and-default-node.yaml", false,
            TestName = "Initial_StartWithBlankIncJobAndNode")]
        [TestCase("default.yaml", "default-with-scrape-job.yaml", true, TestName = "Initial_StartWithDefault")]
        [TestCase("default-with-scrape-job.yaml", "default-with-scrape-job.yaml", false,
            TestName = "Initial_StartWithDefaultIncJob")]
        [TestCase("default-with-scrape-job-and-default-node.yaml", "default-with-scrape-job-and-default-node.yaml",
            false, TestName = "Initial_StartWithDefaultIncJobAndNode")]
        ...
        [TestCase("default-with-scrape-job-and-default-node.yaml", true,
            TestName = "List_StartWithDefaultIncJobAndNode")]
        ...
        [Test]
        [TestCase("blank-with-scrape-job.yaml", "blank-with-scrape-job.yaml", false,
            TestName = "Remove_StartWithBlankIncJob")]
        [TestCase("blank-with-scrape-job-and-default-node.yaml", "blank-with-scrape-job.yaml", true,
            TestName = "Remove_StartWithBlankIncJobAndNode")]
        [TestCase("default-with-scrape-job.yaml", "default-with-scrape-job.yaml", false,
            TestName = "Remove_StartWithDefaultIncJob")]
        [TestCase("default-with-scrape-job-and-default-node.yaml", "default-with-scrape-job.yaml", true,
            TestName = "Remove_StartWithDefaultIncJobAndNode")]
