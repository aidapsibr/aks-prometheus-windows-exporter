...
namespace WindowsPrometheusSync
{
    ...
    internal class PrometheusConfigChangeTracker
    {
        ...
        ///     Thrown if a config already exists for <paramref name="nodeInfo" />
        ///     <see cref="NodeInfo.Name" />
        /// </exception>
        ...
        private YamlMappingNode NodeInfoToStaticConfig(NodeInfo nodeInfo)
        {
            ...
            var result =
                new YamlMappingNode(
                    new KeyValuePair<YamlNode, YamlNode>(NodeTags.Targets,
                        new YamlSequenceNode(new YamlScalarNode(nodeNameAndPort))),
